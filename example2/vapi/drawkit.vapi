...
[CCode (cheader_filename = "structures.h,backend.h,layout.h,hover.h,texture.h,nanosvg.h", lower_case_cprefix = "dk_")]
namespace DrawKit {
    ...
    public class Context {
        ...
        [CCode (cname = "dk_set_padding")]
        public void set_padding(int left, int right, int top);
